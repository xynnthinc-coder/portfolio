...
const AwardEntry: React.FC<AwardEntryProps> = ({
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-start w-full border-b border-white/[.15] py-6 md:py-10 last:border-b-0">
      {/* Entry Number - Displays the sequential number for the Award entry */}
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <div className="flex-1">
          ...
          {/* Title - Displays the title of the Award entry */}
          {/* Adjusted text size for different breakpoints */}
          ...
          {/* Description - Displays the description of the Award entry */}
          {/* Adjusted text size for different breakpoints */}
